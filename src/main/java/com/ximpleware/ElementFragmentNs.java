...
public class ElementFragmentNs {
    ...
    */
    ...
    /**
     * Trim whitespaces surrounding the segment
     */
    public final void trimWhiteSpaces(){
    	vn.trimWhiteSpaces(l);
    }
    /**
     * Trim whitespaces surrounding the segment, could be leading, trailing or both
     * @param actionType VTDNav.WS_LEADING  VTDNav.WS_TRAILING  VTDNav.WS_BOTH
	 *                        public final short VTDNav.WS_LEADING=0;
	 *                        public final short VTDNav.WS_TRAILING=1;
	 *                        public final short VTDNav.WS_BOTH=2;
     */
    public final void trimWhiteSpaces(short actionType){
    	vn.trimWhiteSpaces(l,actionType);
    }
    
    /**
     * Expand the segment to include surrounding white spaces, 
     */
    public final void expandWhiteSpaces(){
    	vn.expandWhiteSpaces(l);
    }
    
    /**
     * Expand the segment to include surrounding white spaces, could be leading, trailing or both
     * @param actionType VTDNav.WS_LEADING  VTDNav.WS_TRAILING  VTDNav.WS_BOTH
	 *                        public final short VTDNav.WS_LEADING=0;
	 *                        public final short VTDNav.WS_TRAILING=1;
	 *                        public final short VTDNav.WS_BOTH=2;
     */
    public final void expandWhiteSpaces(short actionType){
    	vn.expandWhiteSpaces(l, actionType);
    }
