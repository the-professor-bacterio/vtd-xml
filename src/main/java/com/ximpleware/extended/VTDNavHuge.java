...
/*	private int getCharResolved2() throws NavExceptionHuge {
	 ...
	 * @param index
	 * @param s
	 * @return boolean true if token at index contains the string s
	 * @throws NavExceptionHuge
	 */
	...
	**/
	...
	/**
	 * Convert a token into a string, all lower cases character converted to upper case counterpart
	 * no entity reference is resolved
	 * @param index
	 * @return
	 * @throws NavExceptionHuge
	 */
